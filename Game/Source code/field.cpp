...
{
  block = std::unique_ptr<Texture>(new Texture(m));
block->loadFromFile("brick.png");

// Init floor texture
floor = std::unique_ptr<Texture>(new Texture(m));
floor->loadFromFile("floor.png");

// Init body texture
body = std::unique_ptr<Texture>(new Texture(m));
body->loadFromFile("body.png");

// Init head texture
head = std::unique_ptr<Texture>(new Texture(m));
head->loadFromFile("head.png");

// Init apple texture
apple = std::unique_ptr<Texture>(new Texture(m));
apple->loadFromFile("apple.png");


    // Init sound effect
    sound = std::unique_ptr<Sound>(new Sound("scratch.wav"));
